...
<div class="glass relative overflow-hidden rounded-2xl border border-white/10 shadow-2xl">
	...
	<div class="p-6">
		<h3 class="mb-6 text-xl font-black tracking-tight text-white uppercase">Edit Section</h3>
		...
		<div class="space-y-6">
				...
				<div class="grid grid-cols-2 gap-2 sm:grid-cols-3">
					{#each Object.entries(sectionTypes) as [type, config]}
						<button
							...
							onclick={() => (selectedType = type as SectionType)}
						>
			...
			<div class="space-y-2">
				<div class="flex items-center justify-between">
					<label
						...
						for="edit-section-name">Name</label
					>
			...
			<div class="space-y-2">
				<div class="flex items-center justify-between">
					<label
						class="text-[10px] font-bold tracking-widest text-accent-400 uppercase"
						for="edit-section-content">Content</label
					>
		...
		<div class="mt-8 flex gap-3">
			...
			<Button variant="primary" class="flex-1" onclick={handleSubmit}>SAVE CHANGES</Button>
		</div>
	</div>
</div>
